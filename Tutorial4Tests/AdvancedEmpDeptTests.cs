...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMaxSalary()
    {
        ...
        decimal? maxSalary = emps.Max(s => s.Sal);
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps, emp => emp.Mgr, emp2 => emp2.EmpNo,
            (emp, emp2) => new { Employee = emp.EName, Manager = emp2.EName });
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(emp => new { emp.EName, Total = (emp.Comm ?? 0) + emp.Sal });
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            ...
            .SelectMany(emp => grades
                .Where(grade => emp.emp.Sal >= grade.Losal && emp.emp.Sal <= grade.Hisal)
                .Select(grade => new { emp.emp.EName, emp.dept.DName, grade.Grade }));
